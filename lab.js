...
if(temperature >= 80 && rain === true) {
  console.log("You should wear a t-shirt and bring an umbrella today.");
  ...
  console.log('You should wear a jacket today.');
} else if(temperature <= 60 && rain !== true) {
...
// ////////// PROBLEM 9 //////////
// /*
//   Create a variable called 'changeMyMind' and set it equal to true. Check to see if changeMyMind is set to true or false, if it is true, change the status to false, if it is false, change the status to true.
// */
